...
(1, 'shaufiq', 'shaufiq@email.com', 'pesan', 'pesan singkat padat dan jelas');
...
(2, '0002', 'chargin laptop acer', 1, '350000', ''),
(3, '0003', 'audio usb', 12, '35000', ''),
(4, '0004', 'kabel data', 9, '20000', ''),
...
(76, 52, 1, 1, '3200000', '3200000'),
(77, 52, 2, 1, '350000', '350000'),
(78, 52, 4, 1, '20000', '20000');
...
(52, '61F7F6A35AFB11', '2022-01-31 15:48:03', '3570000', '4000000', 'lhjhl', NULL, 1);
...
--
ALTER TABLE `pj_penjualan_detail`
  MODIFY `id_penjualan_d` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `pj_penjualan_master`
--
ALTER TABLE `pj_penjualan_master`
  MODIFY `id_penjualan_m` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

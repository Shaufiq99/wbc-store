            ...
            <form action="<?php echo base_url("Barang/Update_Barang/") ?>" method="post" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Jumlah Barang <span class="required">*</span>
                    </label>
                    <div class="col-md-9">
                      <?php if (!empty($data)) : ?>
                        <?php echo form_input([
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">harga_satuan <span class="required">*</span>
                    </label>
                    <div class="col-md-9">
                      <?php if (!empty($data)) : ?>
                        <?php echo form_input([
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                      ...
                      <a href="<?php echo base_url('barang/') ?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                  </div>
